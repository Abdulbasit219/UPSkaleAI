  ...
  const faqs = [
    {
      ...
      answer:
        "Our AI generates your personalized career roadmap instantly after you complete the initial assessment.",
    },
    {
      question: "Do you offer refunds?",
      answer:
        "Yes, we offer a 14-day money-back guarantee if you're not satisfied with our platform.",
    },
    {
      question: "Can I change my career path later?",
      answer:
        "Absolutely! You can update your goals and get a new roadmap anytime at no additional cost.",
    },
    {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-12">
            {features.map((feature, idx) => (
              ...
              >
                <div
                  className={`${isDark ? "text-purple-300" : "text-purple-500"}`}
                >
                  {feature.icon}
                </div>
        ...
        <div className="grid lg:grid-cols-2 gap-16 mb-24">
          ...
          <div className="lg:sticky lg:top-24 h-fit">
            <div
              className={`backdrop-blur-2xl border-2 rounded-[2rem] p-8 shadow-2xl ${
                isDark
                ...
                {contactMethods.map((method, idx) => (
                  ...
                  >
                    <div className="flex items-center gap-4">
                      <div
                        className={`w-14 h-14 bg-gradient-to-br ${method.color} rounded-2xl flex items-center justify-center flex-shrink-0 shadow-lg group-hover:scale-110 transition-transform duration-300`}
                      >
