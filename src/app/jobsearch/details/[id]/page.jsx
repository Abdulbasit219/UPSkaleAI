        ...
        <div className="max-w-7xl mx-auto px-3 xs:px-4 sm:px-6 lg:px-8 py-6 sm:py-8 pt-16 sm:pt-20">
          ...
          <div className="grid lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8">
            ...
            <div className="lg:col-span-3">
              ...
              >
                <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-4 sm:gap-6 mb-4 sm:mb-6">
                  <div className="flex items-start gap-3 sm:gap-4">
                    <div
                      className={`w-12 h-12 sm:w-16 sm:h-16 md:w-20 md:h-20 bg-gradient-to-br from-purple-500/20 to-pink-500/20 rounded-xl sm:rounded-2xl flex items-center justify-center text-2xl sm:text-3xl md:text-4xl border flex-shrink-0 ${
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div
                        className={`flex flex-col xs:flex-row xs:items-center gap-1 xs:gap-2 sm:gap-3 mb-2 sm:mb-3 flex-wrap ${
                      ...
                      <div
                        className={`flex flex-col xs:flex-row xs:items-center gap-1 xs:gap-2 sm:gap-4 text-xs sm:text-sm flex-wrap ${
                          isDark ? "text-gray-400" : "text-gray-600"
                        }`}
                      >
                ...
                {/* Stats */}
                <div
                  className={`flex items-center gap-3 sm:gap-4 md:gap-6 text-xs sm:text-sm border-t pt-3 sm:pt-4 flex-wrap ${
                    isDark
              ...
              {/* Tabs Navigation */}
              <div
                className={`flex items-center gap-1 mb-4 sm:mb-6 backdrop-blur-xl border rounded-xl sm:rounded-2xl p-1 sm:p-2 overflow-x-auto ${
                  isDark
                    ? "bg-slate-900/50 border-purple-500/20"
                    : "bg-white/80 border-purple-300/30"
                }`}
              ...
              >
                      ...
                      <div className="space-y-3 sm:space-y-4">
                        ...
                        <div className="space-y-2 sm:space-y-3">
                          ...
                          >
                            ...
                            <span
                              className={`group-hover:text-purple-300 transition-colors text-sm sm:text-base ${
                                isDark ? "text-white" : "text-gray-900"
                              }`}
                            >
                              Company Website
                          ...
                          <button
                            className={`flex items-center gap-2 sm:gap-3 p-2 sm:p-3 rounded-lg sm:rounded-xl border transition-all group w-full ${
                              isDark
                                ? "bg-slate-800/50 border-purple-500/20 hover:border-purple-500/40"
                                : "bg-gray-50 border-purple-300/20 hover:border-purple-400/40"
                            }`}
                          >
                            ...
                            <span
                              className={`group-hover:text-blue-300 transition-colors text-sm sm:text-base ${
                                isDark ? "text-white" : "text-gray-900"
                              }`}
                            >
                              LinkedIn Page
                ...
                {activeTab === "benefits" && (
                  <div className="space-y-4 sm:space-y-6">
                    ...
                    <div
                      className={`p-4 sm:p-6 bg-gradient-to-r from-purple-500/10 to-pink-500/10 rounded-lg sm:rounded-xl border ${
                        isDark ? "border-purple-500/20" : "border-purple-300/20"
                      }`}
                    >
                      <h3
            ...
            <div className="lg:col-span-1 space-y-4 sm:space-y-6">
              {/* Apply Card */}
              <div
                className={`backdrop-blur-xl border rounded-xl sm:rounded-2xl p-4 sm:p-6 sticky top-20 sm:top-24 ${
                  isDark
                    ? "bg-slate-900/50 border-purple-500/20"
                    : "bg-white/80 border-purple-300/30"
                }`}
              >
                ...
                >
                  ...
                  >
                    Based on your skills and experience, you're a strong
              ...
              >
                ...
                <button
                  className={`w-full mt-3 sm:mt-4 py-2 sm:py-2.5 border rounded-lg sm:rounded-xl text-xs sm:text-sm font-medium transition-all ${
                    isDark
