...
export default function CareerPathPage() {
  ...
  const currentDetails = currentPath;
      ...
      {isLoading ? (
        <div className="flex items-center justify-center min-h-[60vh]">
          <div className="flex flex-col items-center gap-4">
            ...
            <p
              className={`${isDark ? "text-gray-400" : "text-gray-600"} animate-pulse`}
            >
        ...
        <div className="max-w-7xl mx-auto px-3 xs:px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
          ...
          <div className="text-center mb-8 sm:mb-12">
            ...
            >
              Discover personalized learning journeys and master the skills
              needed for your dream tech career
            </p>
                  ...
                  {careerPaths.map((path) => (
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div
                          className={`text-xs mt-0.5 ${isDark ? "text-gray-400" : "text-gray-600"} hidden xs:block truncate`}
                        >
                          {path.overview}
                        </div>
                      </div>
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex flex-col xs:flex-row xs:items-center gap-2 sm:gap-4 md:gap-6 text-xs sm:text-sm">
                        <div className="flex items-center gap-1 sm:gap-2">
                          ...
                          >
                            {currentPath?.demand || "High"} Demand
                          </span>
                        </div>
                        <div className="flex items-center gap-1 sm:gap-2">
