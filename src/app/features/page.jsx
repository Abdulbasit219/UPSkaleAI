...
export default function FeaturesPage() {
    ...
    ai: [
      {
        ...
        description:
          "Get personalized career roadmaps tailored to your goals, skills, and market demand",
        highlights: [
      ...
      },
      {
        ...
        description:
          "AI-powered skill evaluation through projects, quizzes, and code analysis",
        highlights: [
      ...
      },
      {
        ...
        description:
          "Intelligent job matching based on your skills, preferences, and career trajectory",
        highlights: [
          "95% match accuracy",
          "Salary insights",
          "Company culture fit",
    ...
    learning: [
      {
        ...
        description:
          "Adaptive learning journeys that evolve with your progress and goals",
        highlights: [
      ...
      },
      {
        ...
        description:
          "Detailed insights into your learning journey with actionable recommendations",
        highlights: [
      ...
      },
      {
        ...
        description:
          "Connect with industry experts and peers for guided learning",
        highlights: [
    ...
    career: [
      {
        ...
        description:
          "Create stunning portfolios that showcase your skills and projects",
        highlights: [
      ...
      },
      {
        ...
        description:
          "Comprehensive analytics to track your career growth and opportunities",
        highlights: [
          "Readiness scoring",
    ...
    tools: [
      {
        ...
        description:
          "Built-in development environment for practicing and building projects",
        highlights: [
      ...
      },
      {
        ...
        description:
          "Learn on the go with our fully-featured mobile experience",
        highlights: [
          "Offline learning",
          "Mobile code editor",
          "Push notifications",
  ...
  const testimonials = [
    ...
    },
    {
      ...
      company: "DataCorp",
      content:
        "The personalized learning path and project-based approach helped me build a portfolio that impressed recruiters.",
      avatar: "MR",
      rating: 5,
    },
    {
      ...
      content:
        "Landed my dream job with a 40% salary increase. The career readiness score gave me the confidence to apply.",
      avatar: "PP",
      rating: 5,
    },
  ];
        ...
        <div className="grid lg:grid-cols-3 gap-8 mb-20">
          {features[activeCategory].map((feature, index) => (
            ...
            >
              ...
              {/* CTA */}
              <button
                className={`w-full py-2.5 rounded-lg font-semibold transition-all border flex items-center justify-center gap-2 group-hover:border-purple-500/40 ${
                  isDark
